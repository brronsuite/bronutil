...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/brronsuite/bronutil/coinset)
...
```bash
$ go get -u github.com/brronsuite/bronutil/coinset
```
